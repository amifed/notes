...
1. 根元素或包含根元素的元素
2. 浮动元素 float＝left|right或inherit（≠none）
...
响应式网站设计是一个网站能够兼容多种终端设备，而不是为每一个终端做一个特定的版本。基本原理是通过媒体查询检测不同的设备屏幕尺寸做处理。页面头部必须有meta声明的viewport。
...
[《几种常见的CSS布局》](https://juejin.cn/post/6844903710070407182#heading-12)